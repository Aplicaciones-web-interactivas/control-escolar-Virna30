                            ...
                            <tr class="hover:bg-gray-50 transition-colors duration-150">
                                ...
                                <td class="px-6 py-4 whitespace-nowrap text-sm font-medium">
                                    <a href="{{ route('submissions.download', $submission) }}" 
                                       class="inline-flex items-center px-3 py-1.5 border border-transparent rounded-lg text-xs font-medium text-white bg-neon-pink hover:bg-pink-600 transition-all duration-300 transform hover:scale-105">
                                        <svg class="w-4 h-4 mr-1" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                ...
                                <td class="px-6 py-4 whitespace-nowrap text-sm">
                                    <form action="{{ route('calificaciones.store') }}" method="POST" class="flex items-center space-x-2">
                                        ...
                                        <input type="hidden" name="grupo_id" value="{{ $assignment->grupo_id }}">
                                        ...
                                        <input type="number" 
                                               ...
                                               placeholder="0-10"
                                               class="w-16 px-2 py-1 text-sm border border-gray-300 rounded focus:ring-2 focus:ring-neon-pink">
